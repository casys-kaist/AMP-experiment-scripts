...
class AMP:
    ...
    def get_stats(self):
        ...
        return num_page_migrations, accessed_pages_ratio,\
    ...
    def choose_mig_policy(self):
        ...
        if self.epoch_cnt > 1:
            num_page_migrations, accessed_pages_ratio,\
                    fast_memory_hit_ratio, lru_fast_memory_hit_ratio, lfu_fast_memory_hit_ratio,\
                    fast_memory_access_ratio\
                    = self.get_stats()

            record_stats_single(self.result_dir, self.signature, "num_page_migrations",
                    "%f\n" % (num_page_migrations))
